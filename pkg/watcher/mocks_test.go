...
func (m *MockWatcher) GetStats() models.WorkerStats {
	args := m.Called()
	return args.Get(0).(models.WorkerStats)
}

// MockParser is a mock implementation of parser.ParserInterface
type MockParser struct {
	mock.Mock
}

func (m *MockParser) ParseLogEntry(entry interface{}, logURL, operatorName string) (*models.Certificate, error) {
	args := m.Called(entry, logURL, operatorName)
